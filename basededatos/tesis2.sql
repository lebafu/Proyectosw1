...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2019 a las 22:52:00
...
(109, 17, 'Marco Felipe Castillo Gonzalez', 'Hugo Araya', 1, 'Paulo Gonzalez', 'Ninguno', NULL, 'Ing.', NULL, NULL, NULL, NULL, NULL, NULL, 'Ing.', NULL, NULL, NULL);
...
(17, 'Marco Toranzo', 'marcotoranzo@gmail.com', NULL, '$2y$10$RxyZZIw5NjYkSNL95uaRhuZ8SnoAZsm5QOLGzT30Z/ivnTQfPHJXm', 'Masculino', 2, 0, 'kCjGiT2y0KHCnrQpFaSE01IQG3kr9YRY9nsijJElVwaRIwrvFvp7sgEqjPvy', NULL, '2019-10-13 21:56:39'),
(18, 'Camilo Cavieres', 'CamiloC@gmail.com', NULL, '$2y$10$U9YUF0dsIGH.mtoDiuaOJuho1QeRg/kZCpK9GjiL7h0J24GbsqH/S', 'Masculino', 1, 0, NULL, '2019-07-16 08:27:48', '2019-07-16 08:27:48'),
...
--
ALTER TABLE `recopilacion_inf_titulados`
  ADD CONSTRAINT `recopilacion_inf_titulados_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tesis` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
