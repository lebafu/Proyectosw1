		...
		<div class="container">
			<div class="row">
				...
				<div align="center" style="margin-left: 65px">
						@if($comision->profesor1_grado_academico=="Dr." and $comision->sexo1=="Femenino")
							<b>{{Dra. $comision_profeso1_externo}}</b>
						@endif
						<b>{{$comision->profesor1_grado_academico}}{{$comision->profesor1_externo}}</b>
				</div>
				</div>
			</div>
		</div>
