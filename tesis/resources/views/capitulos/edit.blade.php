            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('capitulos.update', $id)}}" method="POST">
                        ...
                        @else
                             <div class="form-group row">
                            <label for="cap5" class="col-md-4 col-form-label text-md-right">{{ __('Nombre Cap4 de Tesis') }}</label>
                            <div class="col-md-6">
                        ...
                        @else
                             <div class="form-group row">
                            <label for="cap6" class="col-md-4 col-form-label text-md-right">{{ __('Nombre Cap7 de Tesis') }}</label>
                            <div class="col-md-6">
