...
<body>
	...
	<div class="container">
		<div class="row">
			<div>
				<!-- Se define posicion y tamaño de la imagen-->
				<img align="center" src="{{asset('/images/logoucm.png')}}" width="300" height="125"> 
			</div>
			<div>
				<h1 align="left" style="margin-bottom: 10px; margin-top:150px">Recopilación Información Titulados</h1>
			</div>
		</div>
		...
		@if($tes->name==$tes->nombre_completo)
		...
		@elseif($tes->name==$tes->nombre_completo2)
		<h4 style="margin-top:40px">Nombre: {{$tes->name}} </h4>
